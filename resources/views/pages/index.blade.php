		...
		<!--//header-w3l-->
			<!--/banner-info-->
			   <div class="baner-info">   
			      <h3>Wel<span>Come </span>To   <span>Hotel </span> DeMartin</h3>
		...
		<div class="container">
         <div class="footer-info-agile">
				...
				<div class="col-md-3 footer-info-grid address">
					...
					<address>
						<ul>
							<li>42, Hotel Motel Road</li>
							<li>Kolatoli Beach, Cox's Bazar</li>
							<li>Chittagong, Bangladesh</li>
							<li>Telephone : +420 00112233</li>
							<li>Email : <a class="mail" href="mailto:info@example.com">info(at)hoteldemartin.org</a></li>
						</ul>
					</address>
				</div>
